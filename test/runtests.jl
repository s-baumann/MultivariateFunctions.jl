...
println("Test of monotonic MARS spline.")
@time @test include("13_test_monotonic_mars.jl")
println("Test of multivariate fitters.")
@time @test include("14_test_multivariate_fitters.jl")
println("Test of observation weights.")
@time @test include("15_test_weights.jl")
