...
struct Sum_Of_Functions <: MultivariateFunction
    ...
    function Sum_Of_Functions(funcs)
        undefined_funcs  = funcs[typeof.(funcs) .== Missing  ]
...
function ≂(a::UnivariateFunction,b::Missing)
    return false
end
function ≂(a::Missing,b::UnivariateFunction)
    return false
end
function ≂(a::UnivariateFunction,b::UnivariateFunction)
